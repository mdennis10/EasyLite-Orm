...
public final class TableUtil {	
	 ...
	 */
	protected final void createTable (SQLiteDatabase db, Class<?> clazz) throws EasyLiteSqlException{
		try {
	 ...
	 * @exception EasyLiteSqlException when error with sql parsing or execution occurs
	 */
	protected final void dropTable (SQLiteDatabase db,Class<?> clazz) throws EasyLiteSqlException{
		try {
